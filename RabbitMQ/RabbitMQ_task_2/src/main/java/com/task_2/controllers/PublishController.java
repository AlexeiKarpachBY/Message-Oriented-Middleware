...
public class PublishController {
    ...
    ResponseEntity<Void> publishMessage() {
        List<MyMessage> failedMessageList = repository.findAll();
        failedMessageList.forEach(message -> {
    ...
    private MyMessage getValidMessage(MyMessage message) {
        String validMessage = "VALID: ".concat(message.getMessage());
